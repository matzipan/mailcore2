...
namespace mailcore {
    ...
    public:
        ...
        virtual String * plainTextBodyRendering(IMAPMessage * message, String * folder, bool stripWhitespace, HTMLRendererTemplateCallback * htmlCallback, ErrorCode * pError);
